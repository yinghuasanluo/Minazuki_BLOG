...
**Astro Theme Reimu** 是一款以博丽灵梦为灵感、基于 Astro 构建的博客主题，提供文章管理、评论、统计和多语言等功能。

<AlertBlockquote type="info" title="提示">
本站使用 Astro 版本。你可以按自己的需求修改主题配置与页面内容。
</AlertBlockquote>
...
```bash
# 克隆仓库
git clone https://github.com/yinghuasanluo/Minazuki_BLOG.git
cd Minazuki_BLOG
...
Astro Theme Reimu 是一个功能丰富、高度可定制的博客主题。通过本指南，你应该能够快速上手并根据自己的需求进行配置。如果在使用过程中遇到问题，欢迎到[项目仓库](https://github.com/yinghuasanluo/Minazuki_BLOG)反馈。

<AlertBlockquote type="tip">
更多详细信息和更新请查看[项目仓库](https://github.com/yinghuasanluo/Minazuki_BLOG)。
</AlertBlockquote>
